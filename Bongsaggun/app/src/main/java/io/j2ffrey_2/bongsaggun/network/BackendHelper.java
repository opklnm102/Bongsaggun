package io.j2ffrey_2.bongsaggun.network;
...
public class BackendHelper {
    ...
    //검색
    public Call<JsonObject> getSearchList(int categoryId, int regionId, int schoolId, int timeId) {
        return service.getSearchList(categoryId, regionId, schoolId, timeId);
    }

    //검색
    public Call<JsonObject> getSearchList(String strSearch, int categoryId, int regionId, int schoolId, int timeId) {
